...
public class NGuiEventsToPlaymakerFsmEvents : MonoBehaviour
{
	...
	void OnSubmitChange()
	{
		...
		if (debug) Debug.Log("NGuiEventsToPlaymakerFsmEvents OnSubmitChange to "+targetFSM.gameObject.name+"/"+targetFSM.FsmName);
	...
	void OnSliderChange(float value)
	{
		...
		if (debug) Debug.Log("NGuiEventsToPlaymakerFsmEvents OnSliderChange("+value+") to "+targetFSM.gameObject.name+"/"+targetFSM.FsmName);
